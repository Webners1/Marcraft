...
const PricingPage = () => {
    ...
    return (
        <PageContainer display={'flex'} justifyContent={'center'} title="Pricing" description="this is Pricing">
            {/* breadcrumb */}
            ...
            <Grid container spacing={3} justifyContent="center" mt={3}>
                <Grid item xs={12} sm={10} lg={8} textAlign="center">
                    ...
                    <Box display="flex" alignItems="center" mt={3} justifyContent="center">
                        ...
                        <Typography variant="subtitle1">Quarterly</Typography>
                    </Box>
                </Grid>
            </Grid>
            <Grid padding={'0vw 10vw 0vw 10vw'} container spacing={3} mt={5}>
                {pricing.map((price, i) => (
